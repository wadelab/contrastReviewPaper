...
either positive or negative contrast. The responses of each different
type of neuron is an increase in firing rate to the increasing levels of
the prefered contrast polatiry and these neurons typically exhibit zero
(or baseline) response to the non-prefered polarity. We can model the
combined responses of these two cell populations to a time varying
contrast signal by full-wave-rectification. The effect of this
computation is, effectively, to double the input freuquency in the
...
\includegraphics{Figures/4_transducer.pdf_transducer.pdf}
