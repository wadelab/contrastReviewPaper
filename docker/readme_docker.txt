...
5. Call the container something sensible (i.e. contrast), set the host port to 8787, and add an Environment variable called PASSWORD with the value: pass
...
git clone https://github.com/wadelab/contrastReviewPaper.git
This will download the repository to a folder called contrastReviewPaper
