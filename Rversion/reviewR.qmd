...
pdf('Figures/centresurround.pdf',width=12,height=6.5)
...
pdf('Figures/linearsystem.pdf',width=12,height=4)
par(mfrow=c(1,3))
...
pdf('Figures/transducer.pdf',width=12,height=4)
par(mfrow=c(1,3))
...
pdf('Figures/twoinputs.pdf',width=12,height=4)
par(mfrow=c(1,3))
...
pdf('Figures/sweepplot.pdf',width=6,height=6)
...
pdf('Figures/clinicalplot.pdf',width=12,height=12)
par(mfrow=c(2,2))
