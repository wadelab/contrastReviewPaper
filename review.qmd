...
Neurons have a limited dynamic range yet they can transmit information about visual stimuli that span many orders of magnitude. In the domain of contrast, to some extent this is accomplished at a population level - individual neurons typically implement a non-linear, sigmoidal contrast vs response (CRF) transducer [@Albrecht1982; @Tolhurst1981] and different neurons exhibit peak sensitivity (defined as the maximum slope of the function) at different contrast levels [@Carandini1994; @Carandini1998; @Busse2009]. A neuronal population will therefor span a sensitivity range greater than any individual member.
