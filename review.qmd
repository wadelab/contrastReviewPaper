...
An early use of the contrast response function was to provide an automated estimate of contrast sensitivity, without requiring behavioural responses from the participant. Because SSVEP response at detection threshold are very small, this was achieved by measuring the contrast response function at relatively high levels, and extrapolating back along the function to estimate its intercept with the x-axis, which was shown to correspond with psychophysically measured detection thresholds [(REFS)]. This general approach revealed much about the development of visual abilities in infants [@braddick], as well as deficits in neurological disease. 

In well-motivated adults, psychophysical measurements of contrast sensitivity remain the gold standard. However, it is hard to obtain reliable psychophysical data from infants, children and adults with neuological disorders. In these cases, SSVEP measurements represent a fast and efficient method for measuring low-level visual responses [Norcia, Tyler, Braddick, Porciatti, Tsai...].

Measuring the SSVEP at multiple levels was made faster by the development of the ‘sweep VEP’ paradigm in which the stimulus changed its contrast, or some other property, throughout a trial - for example gradually increasing in spatial frequency [Tyler, Nakayama etc 1979]. To avoid hysteresis effects, the sweep is sometimes conducted both up and down in the same experiment [Tyler, Norcia etc: 1985, 1990 etc]. 

In general, SSVEP measurements of infant vision have revealed that the development of spatial acuity for both achromatic and chromatic contrast as well as stereoscopic depth perception was faster than had been supposed previously based on behavioural measures [@DobsonTeller78, @NorciaTyler85, @NorciaGerhard 15]
...
As well as measuing contrast thresholds for a stimulus with a fixed spatiotemporal frequency, this technique can also be used to assess spatial frequency thresholds [ REFS - Almoqbel etc.]. Because of its relative speed and simplicity, this technique has now become a standard for conducting tests of visual acuity in young subjects [Ridder2004 Diva vs Enfant, Hoffman, Bach and Farmer].
