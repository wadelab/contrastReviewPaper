...
[@Tootell1998; @Brefczynski1999; @Buracas2007; @Gandhi1999; @Kastner1999; @Li2008; @Murray2008; @Silver2007; @Somers1999] and EEG signals [@Ding2006, @Muller1998m @MullerHillyard2000, @MorganPNAS1996, @Hillyard1998NNS]. 
...
```{python}
#| label: fig-contrastresponsefunction
...
# Compute waveforms for the 'probe' and 'mask' inputs at the frequencies defined in inputFrequency_Hz
probeModulation = np.sin(2 * np.pi * inputFrequency_Hz[0] * support_S) * inputContrasts[0]
maskModulation =  np.sin(2 * np.pi * inputFrequency_Hz[1] * support_S) * inputContrasts[1]

axs[0].plot(support_S, probeModulation,'k')
axs[0].plot(support_S, maskModulation,'r')
axs[0].set_title('Input modulations', fontsize=10)
axs[0].grid()

# pass both the probe and the mask through the transducer
combinedSignal=simpleTransducerFunction(probeModulation, maskModulation, c50,RMax)

# Compute the FT of the combined signals
