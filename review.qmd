...
In well-motivated adults, psychophysical measurements remain the gold standard. However, it is hard to obtain reliable psychophysical data from infants, children and adults with neuological disorders. In these cases, SSVEP measurements represent a fast and efficient method for measuring low-level visual responses [Norcia, Tyler, Braddick].

Measuring the SSVEP at multiple levels was made faster by the development of the ‘sweep VEP’ paradigm in which the stimulus changes its contrast (or some other property) throughout a trial - for example gradually increasing in contrast or spatial frequency. To avoid hysteresis effects, the sweep was sometimes conducted both up and down in the same experiment [Tyler, Norcia etc]. 
