...
where $C_\mathrm{mask}$ reflects the contrast of the mask component at a distinct frequency from that of the target. The effect of this extra term is to reduce the target response (see right panel of @fig-twoinputs). For a linear contrast axis, the contrast response function becomes shallower, whereas on a logarithmic contrast axis it maintains its steepness and shifts to the right. Suppressive effects of this kind have been obtained using SSVEP with a variety of different types of mask, including orthogonal overlaid masks, surround masks, and dichoptic masks [for a meta-analysis see @Baker2021].
...
2004; Pestelli, Ling, & Carrasco, 2009) ). In principle, this effect may be driven both by modulation of the underlying signal or by additional decision-theoretic factors such as reduction in spatial uncertainty (https://jov.arvojournals.org/article.aspx?articleid=2121966, https://jov.arvojournals.org/article.aspx?articleid=2192826). Early experiments with non-human primates showed little evidence for attentionally-driven changes in neuronal spike rates (Luck,
...
SSVEP measurements of attentional effects on both luminance and chromatic contrast strongly implicated gain control an an underlying mechanism [@DiRusso2001GainControl] but the literature was.  In the late 2000s a comprehensive theoretical model for attentional modulation was developed that framed it as a gain control modulation (Reynolds and Heeger 2009, Boynton Vis Res 2009). This framework has proven to be influential - explaining a wide range of phenomena from the earlier literature and demonstrating the subtle interaction between the size of the attentional 'spotlight' and the stimulus which explains many apparent contradictions in the literature.  (effect of stimulus configuration critical). Then... talk about Lauriten et al, Verghese (2 papers) maybe mention Crognale / Highsmith, Wang+Wade and Jasna's paper from 2018. https://www.sciencedirect.com/science/article/abs/pii/S1053811918303860) Probably lots more Carasco ...
