...
This possibility was recognised in the early days of the technique [@Regan1988]. Although characterising the complete set of computations along entire processing pathway is problematic, careful parametric variation of the input stimuli does allow us to fit models of early visual gain control using SSVEP data. ... MORE HERE - Although this idea was suggested as early as 1988 (probably earlier) not many people seem to have done it much. @Candy2001; @Busse2009; @Tsai2012; @Baker2017 *** SEE ALSO RECENT WORK FROM WINAWER LAB - MUCH OF IT IS 'FAST' VEPs ***
