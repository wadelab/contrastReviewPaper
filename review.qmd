...
:::
::: {.content-visible unless-format="docx"}
![Demonstration of how two inputs of different frequencies are processed by a nonlinear transducer. Additional harmonics are apparent in the Fourier spectrum (middle panel), and the contrast response function is suppressed (right panel). The effects of using different nonlinearities can be explored in the accompanying code.](Figures/4_twoinputs.pdf){#fig-twoinputs}
:::
...
The approach of estimating visual thresholds by extrapolating SSVEP responses at higher stimulus levels has revealed much about the development of visual abilities in infants [@Harris1976; @Braddick1986; @Atkinson1979]. In general, SSVEP measurements of infant vision have revealed that contrast sensitivity and acuity for both achromatic and chromatic stimuli as well as stereoscopic depth perception develops earlier than had been supposed previously based on behavioural readouts [@Dobson1978; @Norcia1985b]. For example, using SSVEPs, Norcia and Tyler [@Norcia1985b] found acuity thresholds in 1 month old infants that were roughly half those estimated previously from behavioural experiments (reviewed in [@brownDevelopmentVisualSensitivity1990a]).
SSVEP measures of thresholds for detecting purely chromatic stimuli find responses to isoluminant stimuli by around 5 to 6 weeks with contrast detection reaching near-adult levels by around six months [@morroneDevelopmentInfantContrast1993]. Spatial acuity as measured by SSVEP reaches adult levels more slowly, but near-adult levels are recorded around one year [@Norcia1985b; @Hamer1989] compared to around six to seven years with behavioural measures [@Ellemberg1999; @Atkinson1983]. At least some of this difference is likely due to the relative objectivity and high SNR of the SSVEP technique compared to other methods such as preferential looking, which require careful measurement of the infant's gaze direction.  In slightly older chilren, other groups have reported electrophysiological correlates of visual acuity that more closely match the behavioural measures [@De-Vries-Khoe1982].

The ability to use information from both eyes 
 
The SSVEP technique has also been used to study the development of the contrast gain control mechanisms described in the previous section. Although response- [@Morrone1986] or contrast gain control [@Candy2001; ; @Skoczenski1998] is measurable in infants as young as six weeks old, its development appears to be slower, with adult levels being reached at approximately 11 years [@Pei2017]. 
