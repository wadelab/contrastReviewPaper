...
plt.tight_layout()
plot.savefig('Figures/centresurround.pdf')
...
axs[2].grid()
plt.tight_layout()
plot.savefig('Figures/linearsystem.pdf')
...
axs[2].grid()
plt.tight_layout()
plot.savefig('Figures/transducer.pdf')
...
axs[2].grid()
plt.tight_layout()
plot.savefig('Figures/twoinputs.pdf')
...
![Linear.](Figures/transducer.pdf){#fig-transducer}

![Linear.](Figures/twoinputs.pdf){#fig-twoinputs}
